 ...
 *
 */
public final class NonBlockingStatsDClient extends StatsDClient {
    ...
    private NonBlockingUdpSender sender;
     ...
     * @throws com.amazon.statsdclient.StatsDClientException
     *     if the client could not be started
     */

    public NonBlockingStatsDClient(String prefix, String domain, int port) throws StatsDClientException {
        this(prefix, domain, port, NO_OP_HANDLER);
    }
     ...
     *     if the client could not be started
     */
    public NonBlockingStatsDClient(String prefix, String domain, int port, StatsDClientErrorHandler errorHandler) throws StatsDClientException {
        this.prefix = (prefix == null || prefix.trim().isEmpty()) ? "" : (prefix.trim() + ".");
        this.domain = domain;
        this.port = port;
        try {
            this.sender = new NonBlockingUdpSender(domain, port, STATS_D_ENCODING, errorHandler);
        } catch (Exception e) {
    ...
    /*package*/ void reset () {
        stop();
        try {
            this.sender = new NonBlockingUdpSender(domain, port, STATS_D_ENCODING, NO_OP_HANDLER);
        } catch (Exception e) {
            throw new StatsDClientException("Failed to reset StatsD client", e);
        }
    }

    @Override
    public boolean equals (Object o) {
        if (o instanceof NonBlockingStatsDClient) {
            NonBlockingStatsDClient other = (NonBlockingStatsDClient) o;
            return this.prefix.equals(other.prefix) && this.domain.equals(other.domain) && this.port == other.port;
        }
        return false;
    }
    ...
    /*package*/ boolean equals (String prefix, String hostname, int port) {
        return this.prefix.equals(prefix) && this.domain.equals(hostname) && this.port == port;
    }
